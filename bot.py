...
async def setup_bot_application():
    ...
    telegram_app_instance.add_handler(CommandHandler("view", bot_instance_global.view_categories))
    telegram_app_instance.add_handler(CommandHandler("compare", bot_instance_global.compare_expenses))
    telegram_app_instance.add_handler(CommandHandler("summary", bot_instance_global.show_summary))
    telegram_app_instance.add_handler(CommandHandler("invest", bot_instance_global.invest))
    telegram_app_instance.add_handler(CommandHandler("inv_compare", bot_instance_global.compare_investments))
    telegram_app_instance.add_handler(CommandHandler("loan", bot_instance_global.loan))
